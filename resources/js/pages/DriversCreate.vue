        ...
        'aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive">
                            ...
                            <div class="grid sm:grid-cols-1 gap-4 md:grid-cols-4">
                                 <div class="grid gap-2 w-sm-full">
                                    ...
                                    <Input id="vechile_number" type="text" :tabindex="2"  autocomplete="vechile_number" v-model="form.vechile_number" placeholder="Vechile Number" @input="form.vechile_number = form.vechile_number.toUpperCase()" />
                                    <InputError :message="form.errors.vechile_number" />
                                </div>
                                <div class="grid gap-4 w-sm-full">
                                    <Label for="vechile_color">Cab Color</Label>
                                    <Input id="vechile_color" type="text" :tabindex="2" autocomplete="vechile_color" v-model="form.vechile_color" placeholder="Vechil Color" />
                                    <InputError :message="form.errors.vechile_color" />
                                </div>
                                <div class="grid gap-4 w-sm-full">
                                    <Label for="vechile_model">Cab model</Label>
                                    <Input id="vechile_model" type="text" :tabindex="2" autocomplete="vechile_model" v-model="form.vechile_model" placeholder="Vechile model" />
                                    <InputError :message="form.errors.vechile_model" />
                                </div>
                                <div class="grid gap-4 w-sm-full">
                                    <Label for="vechile_capacity">Cab capacity</Label>
                                    <Input id="vechile_capacity" type="number" :tabindex="2" autocomplete="Vechile Capacity" v-model="form.vechile_capacity" placeholder="Vechile Capacity" />
